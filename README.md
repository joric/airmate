...
A small ESP-12F (ESP8266)-based DIY IR controller originally designed for the Airmate Mystery MSF-2414 fan.
...
F12 protocol pulse spec is `<1,-3|3,-1>` (ZeroPulseSeq=1,-3; OnePulseSeq=3,-1) means 3x duration followed by 1x duration is bit 1; 1x duration followed by 3x duration is bit 0.

`[+1330,-438],[+1258,-440],[+410,-1288],[+1260,-438],[+1258,-440],[+384,-1312],... = [1],[1],[0],[1],[1],[0],`

(Durations are not exact, they were captured from the actual IR remote and decoded backwards but they work.)

I.e. [+1330,-438] is (+3,-1) because it's about 1320 (3x 440) time units on followed by 440 (1x 440) time units LED off.
...
This web interface can decode captured frequencies back into F12 format: https://joric.github.io/airmate/
